...
from cut_image import Graphics
...
def compress_photo():
    '''调用压缩图片的函数
    '''
    src_dir, des_dir = r"photos/", r"E:min_photos/"
...
def handle_photo():
    ...
    '''
    src_dir, des_dir = r"photos/", r"min_photos/"
    ...
    with open(r"E:/test/blog/source/photos/data.json", "w") as fp:
